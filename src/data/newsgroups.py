...
TRAIN_DATA_PATH = join("data", "fashion_mnist", "train")
TEST_DATA_PATH = join("data", "fashion_mnist", "test")
...
class Dataset(BaseDataset):
    ...
    def __init__(
        ...
        loading_transforms = [ToTensor(), Normalize(.5, .5)] if attack is None else [ToTensor(), Normalize(.5, .5), attack]
